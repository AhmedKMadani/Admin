...
import static com.nymeria.admin.Utiliti.PreferenceUtil.savePreference;


/**
 * Created by AhmedKamal on 8/22/2017.
 */
...
public class UtilMethods {
    ...
    public static void mailTo(Context context, String address) {
        ...
        emailIntent.putExtra( Intent.EXTRA_SUBJECT, "Halls ");
    ...
    public static void sendMail(Context context, String name, String address) {
        ...
        context.startActivity( Intent.createChooser(emailIntent, "Halls with Us!"));
    }
